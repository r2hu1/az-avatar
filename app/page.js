  ...
  return (
    <main className="sm:grid place-items-center">
      <div className="p-6 max-w-2xl">
        ...
        <p className="text-gray-500 text-[14px]">Generate an customized avatar with a url for free!</p>
        ...
        <div className="mt-8">
          ...
          <div className="mt-2">
            <h2 className="text-lg font-medium">TextColor</h2>
            <p className="text-[14px] text-gray-500">
          ...
          <div className="mt-2">
            <h2 className="text-lg font-medium">FontSize</h2>
            <p className="text-[14px] text-gray-500">
          ...
          <div className="mt-2">
            <h2 className="text-lg font-medium">BgColor</h2>
            <p className="text-[14px] text-gray-500">
          ...
          <div className="mt-2">
            <h2 className="text-lg font-medium">Width</h2>
            <p className="text-[14px] text-gray-500">
        ...
        <div className="flex gap-3 mt-8">
          <a href="https://github.com/r2hu1/az-avatar" className="hover:bg-gray-300 hover:text-black transition flex items-center bg-none border border-gray-300 h-10 text-sm text-gray-300 px-4 rounded-md">Github</a>
          <a href="https://github.com/r2hu1/az-avatar" className="hover:bg-gray-300 hover:text-black transition flex items-center bg-none border border-gray-300 h-10 text-sm text-gray-300 px-4 rounded-md">Star</a>
        </div>
      </div>
    </main>
  )
